...
This project is the Avatar Game. It has the following structure:
    ...
    │   ├── resources                       # JSON files for the layout and the images
...
The ADE20K for VQA could be found in: https://drive.google.com/file/d/1EWMHAafdAba2wUv56bvdg8UrV9h9rw6V/view?usp=sharing
