...
from avatar_models.vqa.attention_vqa import build_co_attention_model
import pickle
import numpy as np
from avatar_models.vqa.create_preprocessed_questions import preprocess_english, preprocess_english_add_tokens
from config.util import get_config

class TrainedVQA:

    def __init__(self, model_path, tokenizer_path, label_encoder_path):
        #self.model = keras.avatar_models.load_model(model_path)
