...
from avatar_models.vqa.lxmert.utils import WEIGHTS_NAME, Config, cached_path, hf_bucket_url, is_remote_url, load_checkpoint
...
class BottleneckBlock(ResNetBlockBase):
    def __init__(
        ...
        # The original MSRA ResNet avatar_models have stride in the first 1x1 conv
...
class RPN(nn.Module):
    ...
    def forward(self, images, image_shapes, features, gt_boxes=None):
        ...
        # For RPN-only avatar_models, the proposals are the final output
