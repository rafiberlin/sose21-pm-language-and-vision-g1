    ...
    def _prepare_inputs_for_qg_from_answers_hl(self, sents, answers):
        ...
        for i, answer in enumerate(answers):
            ...
            for answer_text in answer:
                sent = sents[i]
                sents_copy = sents[:]
                # Work around, as all answers seems to be pre-padded in the hugging face transformner version we use
                # 4.x vs 3.0.0 in the original repo
                answer_text = answer_text.split("<pad> ")[1]
